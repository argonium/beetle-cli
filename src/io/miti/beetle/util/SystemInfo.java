...
public final class SystemInfo
{
      ...
      if (firstPeriodIndex < 0) {
        ...
        if (secondPeriodIndex < 0) {
          ...
          majorVersion = Integer
              .parseInt(verStr.substring(0, firstPeriodIndex));

          // Parse the minor version number (everything between the first 2
          // periods)
          minorVersion = Integer.parseInt(verStr.substring(
              firstPeriodIndex + 1, secondPeriodIndex));
        }
      }
    }
  }
   ...
   */
  public static boolean meetsOrExceedsVersionNumber(final int nMajor,
      final int nMinor) {
