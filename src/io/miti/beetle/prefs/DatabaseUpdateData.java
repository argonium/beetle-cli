...
public final class DatabaseUpdateData
{
  ...
  /**
   * Return whether any updates are available for the source version and
   * not greater than the target bound.
   *  
  ...
  /**
   * Return the best update for the specified source version
   * of the database, where the target is not higher than the
   * target bound.  If no such match found, it returns null.
   * 
  ...
  /**
   * Return the available updates for the specified source version
   * of the database.
   * 
   * @param sourceRev the source version to match on
   * @param targetRevBound the upper bound on the target version
